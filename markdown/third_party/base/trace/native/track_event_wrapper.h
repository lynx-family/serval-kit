...
#ifndef MARKDOWN_THIRD_PARTY_BASE_TRACE_NATIVE_TRACK_EVENT_WRAPPER_H_
#define MARKDOWN_THIRD_PARTY_BASE_TRACE_NATIVE_TRACK_EVENT_WRAPPER_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_TRACE_NATIVE_TRACK_EVENT_WRAPPER_H_
