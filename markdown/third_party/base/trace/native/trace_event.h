...
#ifndef MARKDOWN_THIRD_PARTY_BASE_TRACE_NATIVE_TRACE_EVENT_H_
#define MARKDOWN_THIRD_PARTY_BASE_TRACE_NATIVE_TRACE_EVENT_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_TRACE_NATIVE_TRACE_EVENT_H_
