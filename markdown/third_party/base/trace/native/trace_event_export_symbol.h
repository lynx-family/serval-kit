...
#ifndef MARKDOWN_THIRD_PARTY_BASE_TRACE_NATIVE_TRACE_EVENT_EXPORT_SYMBOL_H_
#define MARKDOWN_THIRD_PARTY_BASE_TRACE_NATIVE_TRACE_EVENT_EXPORT_SYMBOL_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_TRACE_NATIVE_TRACE_EVENT_EXPORT_SYMBOL_H_
