...
#ifndef MARKDOWN_THIRD_PARTY_BASE_SRC_BASE_TRACE_TRACE_EVENT_H_
#define MARKDOWN_THIRD_PARTY_BASE_SRC_BASE_TRACE_TRACE_EVENT_H_
...
#define BASE_TRACE_EVENT(category, name)              \
  struct BASE_INTERNAL_TRACE_EVENT_UID(ScopedEvent) { \
    struct BaseEventFinalizer {                       \
      BaseEventFinalizer(...) {}                      \
      ~BaseEventFinalizer() {                         \
        BASE_TRACE_EVENT_END(category, name);         \
      }                                               \
    } base_finalizer;                                 \
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_SRC_BASE_TRACE_TRACE_EVENT_H_
