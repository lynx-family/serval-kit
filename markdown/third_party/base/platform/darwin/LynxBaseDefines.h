...
#ifndef MARKDOWN_THIRD_PARTY_BASE_PLATFORM_DARWIN_LYNXBASEDEFINES_H_
#define MARKDOWN_THIRD_PARTY_BASE_PLATFORM_DARWIN_LYNXBASEDEFINES_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_PLATFORM_DARWIN_LYNXBASEDEFINES_H_
