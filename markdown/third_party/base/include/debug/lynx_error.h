...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_DEBUG_LYNX_ERROR_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_DEBUG_LYNX_ERROR_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_DEBUG_LYNX_ERROR_H_
