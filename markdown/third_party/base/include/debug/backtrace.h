...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_DEBUG_BACKTRACE_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_DEBUG_BACKTRACE_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_DEBUG_BACKTRACE_H_
