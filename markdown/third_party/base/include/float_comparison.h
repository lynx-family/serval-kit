...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_FLOAT_COMPARISON_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_FLOAT_COMPARISON_H_
...
inline bool IsZero(const double d) {
  return DoublesEqual(d, 0.00000L);
}
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_FLOAT_COMPARISON_H_
