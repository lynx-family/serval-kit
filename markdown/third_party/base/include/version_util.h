...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_VERSION_UTIL_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_VERSION_UTIL_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_VERSION_UTIL_H_
