...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_GEOMETRY_RECT_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_GEOMETRY_RECT_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_GEOMETRY_RECT_H_
