...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_GEOMETRY_SIZE_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_GEOMETRY_SIZE_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_GEOMETRY_SIZE_H_
