...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_GEOMETRY_POINT_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_GEOMETRY_POINT_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_GEOMETRY_POINT_H_
