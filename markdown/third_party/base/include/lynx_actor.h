...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_LYNX_ACTOR_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_LYNX_ACTOR_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_LYNX_ACTOR_H_
