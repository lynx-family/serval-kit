...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_ALGORITHM_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_ALGORITHM_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_ALGORITHM_H_
