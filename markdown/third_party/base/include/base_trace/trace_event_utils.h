...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_BASE_TRACE_TRACE_EVENT_UTILS_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_BASE_TRACE_TRACE_EVENT_UTILS_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_BASE_TRACE_TRACE_EVENT_UTILS_H_
