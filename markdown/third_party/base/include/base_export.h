...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_BASE_EXPORT_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_BASE_EXPORT_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_BASE_EXPORT_H_
