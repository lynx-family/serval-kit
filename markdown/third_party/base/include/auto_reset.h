...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_AUTO_RESET_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_AUTO_RESET_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_AUTO_RESET_H_
