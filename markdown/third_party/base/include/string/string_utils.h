...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_STRING_STRING_UTILS_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_STRING_STRING_UTILS_H_
...
inline bool IsInUtf16BMP(char16_t c) {
  return (c & 0xF800) != 0xD800;
}

inline bool IsLeadingSurrogate(char16_t c) {
...
constexpr bool IsASCII(UChar c) {
  return !(c & ~0x7F);
}

constexpr bool IsASCIINumber(UChar c) {
  return c >= '0' && c <= '9';
}
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_STRING_STRING_UTILS_H_
