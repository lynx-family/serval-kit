...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_STRING_STRING_NUMBER_CONVERT_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_STRING_STRING_NUMBER_CONVERT_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_STRING_STRING_NUMBER_CONVERT_H_
