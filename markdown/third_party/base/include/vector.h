...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_VECTOR_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_VECTOR_H_
...
BASE_VECTOR_INLINE void HeapFree(void* ptr) {
  std::free(ptr);
}
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_VECTOR_H_
