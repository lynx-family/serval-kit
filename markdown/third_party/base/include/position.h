...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_POSITION_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_POSITION_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_POSITION_H_
