...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_DATAURI_UTILS_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_DATAURI_UTILS_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_DATAURI_UTILS_H_
