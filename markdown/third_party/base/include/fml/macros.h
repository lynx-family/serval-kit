...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_FML_MACROS_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_FML_MACROS_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_FML_MACROS_H_
