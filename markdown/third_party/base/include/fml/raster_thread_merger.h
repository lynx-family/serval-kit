...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_FML_RASTER_THREAD_MERGER_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_FML_RASTER_THREAD_MERGER_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_FML_RASTER_THREAD_MERGER_H_
