...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_FML_UNIQUE_OBJECT_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_FML_UNIQUE_OBJECT_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_FML_UNIQUE_OBJECT_H_
