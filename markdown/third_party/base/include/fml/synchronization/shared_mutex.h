...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_FML_SYNCHRONIZATION_SHARED_MUTEX_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_FML_SYNCHRONIZATION_SHARED_MUTEX_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_FML_SYNCHRONIZATION_SHARED_MUTEX_H_
