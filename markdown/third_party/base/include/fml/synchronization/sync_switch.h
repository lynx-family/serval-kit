...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_FML_SYNCHRONIZATION_SYNC_SWITCH_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_FML_SYNCHRONIZATION_SYNC_SWITCH_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_FML_SYNCHRONIZATION_SYNC_SWITCH_H_
