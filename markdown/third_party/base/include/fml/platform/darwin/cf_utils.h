...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_FML_PLATFORM_DARWIN_CF_UTILS_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_FML_PLATFORM_DARWIN_CF_UTILS_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_FML_PLATFORM_DARWIN_CF_UTILS_H_
