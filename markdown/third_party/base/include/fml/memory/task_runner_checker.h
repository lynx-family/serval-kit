...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_FML_MEMORY_TASK_RUNNER_CHECKER_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_FML_MEMORY_TASK_RUNNER_CHECKER_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_FML_MEMORY_TASK_RUNNER_CHECKER_H_
