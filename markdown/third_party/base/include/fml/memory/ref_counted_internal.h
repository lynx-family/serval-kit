...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_FML_MEMORY_REF_COUNTED_INTERNAL_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_FML_MEMORY_REF_COUNTED_INTERNAL_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_FML_MEMORY_REF_COUNTED_INTERNAL_H_
