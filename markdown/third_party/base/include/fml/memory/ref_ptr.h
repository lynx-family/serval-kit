...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_FML_MEMORY_REF_PTR_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_FML_MEMORY_REF_PTR_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_FML_MEMORY_REF_PTR_H_
