...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_FML_TIME_TIMESTAMP_PROVIDER_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_FML_TIME_TIMESTAMP_PROVIDER_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_FML_TIME_TIMESTAMP_PROVIDER_H_
