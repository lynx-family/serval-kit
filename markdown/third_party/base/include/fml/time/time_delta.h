...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_FML_TIME_TIME_DELTA_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_FML_TIME_TIME_DELTA_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_FML_TIME_TIME_DELTA_H_
