...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_FML_TIME_TIMER_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_FML_TIME_TIMER_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_FML_TIME_TIMER_H_
