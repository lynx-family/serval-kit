...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_FML_TIME_TIME_POINT_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_FML_TIME_TIME_POINT_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_FML_TIME_TIME_POINT_H_
