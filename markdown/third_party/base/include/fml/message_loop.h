...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_FML_MESSAGE_LOOP_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_FML_MESSAGE_LOOP_H_
#include <iostream>
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_FML_MESSAGE_LOOP_H_
