...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_LOG_ALOG_WRAPPER_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_LOG_ALOG_WRAPPER_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_LOG_ALOG_WRAPPER_H_
