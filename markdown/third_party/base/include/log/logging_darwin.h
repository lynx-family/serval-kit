...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_LOG_LOGGING_DARWIN_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_LOG_LOGGING_DARWIN_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_LOG_LOGGING_DARWIN_H_
