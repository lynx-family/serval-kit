...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_LOG_LOG_STREAM_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_LOG_LOG_STREAM_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_LOG_LOG_STREAM_H_
