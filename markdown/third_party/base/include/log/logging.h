...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_LOG_LOGGING_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_LOG_LOGGING_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_LOG_LOGGING_H_
