...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_THREAD_BASE_SEMAPHORE_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_THREAD_BASE_SEMAPHORE_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_THREAD_BASE_SEMAPHORE_H_
