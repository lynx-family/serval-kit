...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_THREAD_TIMED_TASK_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_THREAD_TIMED_TASK_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_THREAD_TIMED_TASK_H_
