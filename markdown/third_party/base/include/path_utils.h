...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_PATH_UTILS_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_PATH_UTILS_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_PATH_UTILS_H_
