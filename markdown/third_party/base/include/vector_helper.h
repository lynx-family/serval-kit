...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_VECTOR_HELPER_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_VECTOR_HELPER_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_VECTOR_HELPER_H_
