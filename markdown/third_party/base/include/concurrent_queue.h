...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_CONCURRENT_QUEUE_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_CONCURRENT_QUEUE_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_CONCURRENT_QUEUE_H_
