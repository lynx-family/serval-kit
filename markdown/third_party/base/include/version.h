...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_VERSION_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_VERSION_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_VERSION_H_
