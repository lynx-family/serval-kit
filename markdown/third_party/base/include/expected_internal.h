...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_EXPECTED_INTERNAL_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_EXPECTED_INTERNAL_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_EXPECTED_INTERNAL_H_
