...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_SORTED_FOR_EACH_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_SORTED_FOR_EACH_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_SORTED_FOR_EACH_H_
