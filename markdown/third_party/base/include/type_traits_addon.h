...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_TYPE_TRAITS_ADDON_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_TYPE_TRAITS_ADDON_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_TYPE_TRAITS_ADDON_H_
