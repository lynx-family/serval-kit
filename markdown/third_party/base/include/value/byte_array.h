...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_VALUE_BYTE_ARRAY_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_VALUE_BYTE_ARRAY_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_VALUE_BYTE_ARRAY_H_
