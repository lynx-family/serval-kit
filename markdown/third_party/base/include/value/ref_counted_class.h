...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_VALUE_REF_COUNTED_CLASS_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_VALUE_REF_COUNTED_CLASS_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_VALUE_REF_COUNTED_CLASS_H_
