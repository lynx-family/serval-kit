...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_VALUE_REF_TYPE_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_VALUE_REF_TYPE_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_VALUE_REF_TYPE_H_
