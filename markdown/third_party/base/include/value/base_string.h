...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_VALUE_BASE_STRING_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_VALUE_BASE_STRING_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_VALUE_BASE_STRING_H_
