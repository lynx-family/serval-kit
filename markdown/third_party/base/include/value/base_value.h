...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_VALUE_BASE_VALUE_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_VALUE_BASE_VALUE_H_
...
#undef NumberConstructor
  ...
  inline bool Bool() const {
    if (value_.type != lynx_value_bool)
      return !IsFalse();
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_VALUE_BASE_VALUE_H_
