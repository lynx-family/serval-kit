...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_VALUE_LYNX_VALUE_TYPES_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_VALUE_LYNX_VALUE_TYPES_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_VALUE_LYNX_VALUE_TYPES_H_
