...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_VALUE_LYNX_VALUE_EXTENDED_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_VALUE_LYNX_VALUE_EXTENDED_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_VALUE_LYNX_VALUE_EXTENDED_H_
