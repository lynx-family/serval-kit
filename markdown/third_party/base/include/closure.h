...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_CLOSURE_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_CLOSURE_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_CLOSURE_H_
