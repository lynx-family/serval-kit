...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_LINKED_HASH_MAP_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_LINKED_HASH_MAP_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_LINKED_HASH_MAP_H_
