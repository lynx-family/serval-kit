...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_EXPECTED_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_EXPECTED_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_EXPECTED_H_
