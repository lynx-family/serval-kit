...
#ifndef MARKDOWN_THIRD_PARTY_BASE_INCLUDE_BASE_DEFINES_H_
#define MARKDOWN_THIRD_PARTY_BASE_INCLUDE_BASE_DEFINES_H_
...
#endif  // MARKDOWN_THIRD_PARTY_BASE_INCLUDE_BASE_DEFINES_H_
