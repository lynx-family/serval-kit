...
class MarkdownValueConvert {
 public:
  static std::unique_ptr<serval::markdown::Value> ConvertObject(NSObject* object);
  ...
  static std::unique_ptr<serval::markdown::Value> ConvertString(NSString* string);
  static std::unique_ptr<serval::markdown::Value> ConvertNumber(NSNumber* number);
};
