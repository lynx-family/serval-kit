...
extern "C"
JNIEXPORT void JNICALL
Java_com_lynx_markdown_ServalMarkdownView_nativeSetNumberConfig(JNIEnv *env,
                                                                jobject thiz,
                                                                jlong instance,
                                                                jint key,
                                                                jdouble value) {
  ...
  switch (config_key) {
    case kConfigKeyAnimationType:
      view->GetMarkdownView()->SetAnimationType(static_cast<lynx::markdown::MarkdownAnimationType>(static_cast<int>(value)));
      break;
...
extern "C"
JNIEXPORT void JNICALL
Java_com_lynx_markdown_ServalMarkdownView_nativeSetStringConfig(JNIEnv *env,
                                                                jobject thiz,
                                                                jlong instance,
                                                                jint key,
                                                                jstring value) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_lynx_markdown_ServalMarkdownView_nativeSetValueConfig(JNIEnv *env,
                                                               jobject thiz,
                                                               jlong instance,
                                                               jint key,
                                                               jbyteArray config) {
